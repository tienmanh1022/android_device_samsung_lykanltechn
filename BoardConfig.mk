...
# Kernel
#TARGET_KERNEL_CONFIG := lykanltechn_defconfig
#TARGET_KERNEL_SOURCE := kernel/samsung/sdm845
TARGET_PREBUILT_KERNEL := device/samsung/lykanltechn/Image.gz-dtb
...
# Recovery
TARGET_OTA_ASSERT_DEVICE := lykanltechn
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_HAS_NO_SELECT_BUTTON := true
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_RECOVERY_FSTAB := device/samsung/lykanltechn/recovery.fstab
...
#TW_INCLUDE_FBE := true
#TARGET_CRYPTFS_HW_PATH := device/samsung/lykanltechn/cryptfs_hw
